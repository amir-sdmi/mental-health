...
from flask_restful import Resource
import pandas as pd
from services.data_scaling import filter_and_prepare_data, combine_features
from services.regression_analyzer import perform_regression
...
class DataQuery(Resource):
    def get(self, countryName, startDate, endDate):
        ...
        combined_features = combine_features(mh_features, wh_features, gdp_features)
